...
export default function ContactPage() {
  return (
    <Page label="Contact" title="Let's talk about your hiring needs.">
      <p>
      ...
      <ul>
        ...
        <li>Whether you plan to manage the engineer yourself or have Antonio do it.</li>
      ...
      <p>
        After a first exchange over email, Antonio usually schedules a short call to understand your
        needs in more depth. From there you receive a written proposal with scope, timeline and
